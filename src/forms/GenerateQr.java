...
public class GenerateQr extends javax.swing.JFrame {
    ...
    public GenerateQr() {
        initComponents();
        BDUtility.setImage(this, "images/abc1.jpg", 1149, 528);
    ...
    private void initComponents() {
        ...
        userTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Gender", "Email", "Contact", "Address", "Province", "Country", "Registration Id"
            }
        ));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(btnSaveQrAt, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnSaveQrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveQrActionPerformed
        try{
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "OR Code saved successfully");
            }catch(Exception ex){
                JOptionPane.showMessageDialog(this, "Error saving OR code.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        out = QRCode.from(jsonData).withSize(255, 280).to(ImageType.PNG).stream();
        try{
       ...
       try{
           ...
           if(userSelection == JFileChooser.APPROVE_OPTION){
               ...
               try{
                   ...
                   JOptionPane.showMessageDialog(this, "OR Code Save Successfully");
               }catch(Exception ex){
